...
public class IPv6Address extends IPAddress<IPv6Address> implements Writeable{
    ...
    private static class Reader implements HCPMessageReader<IPv6Address> {
        @Override
        public IPv6Address readFrom(ChannelBuffer bb) throws HCPParseError {
    ...
    public boolean equals(Object other) {
        ...
        if (getClass() != other.getClass())
            return false;
        IPv6Address obj = (IPv6Address) other;
        if (raw1 != obj.raw1)
            return false;
        if (raw2 != obj.raw2)
            return false;
    ...
    public int hashCode() {
        int prime=31;
        int result=1;
        result=result*prime+(int)raw1;
        result=result*prime+(int)raw2;
        return result;
    }
