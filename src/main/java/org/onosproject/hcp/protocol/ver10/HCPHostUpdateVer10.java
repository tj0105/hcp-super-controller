 ...
 * @Version 1.0
 */
public class HCPHostUpdateVer10 implements HCPHostUpdate {
    public final static Logger logger= LoggerFactory.getLogger(HCPHostUpdateVer10.class);
    ...
    HCPHostUpdateVer10(long xid, DomainId domainid, List<HCPHost> hostlist){
        if (hostlist==null){
            throw new NullPointerException("HCPHostUpdateVer10: property hostlist must not be null");
        }
        if (domainid==null){
            throw new NullPointerException("HCPHostUpdateVer10: property domainId must not be null");
        }
        this.xid=xid;
    ...
    public HCPType getType() {
        return HCPType.HCP_HOST_UPDATE;
    }
    ...
    static class Writer implements HCPMessageWriter<HCPHostUpdateVer10>{

        @Override
        public void write(ChannelBuffer bb, HCPHostUpdateVer10 message)  {
    ...
    static class Reader implements HCPMessageReader<HCPHostUpdate>{

        @Override
        public HCPHostUpdate readFrom(ChannelBuffer bb) throws HCPParseError {
            ...
            if (type!=(byte) HCPType.HCP_HOST_UPDATE.value())
                throw new HCPParseError("Wrong type:Expected=HCPType.HCP_HOST_UPDATE(13),got="+type);
            ...
            return new HCPHostUpdateVer10(xid,domainId,hosts);
        }
    }

    static class Builder implements HCPHostUpdate.Builder{
        ...
        @Override
        public HCPHostUpdate build() {
            long xid=this.xidSet? this.xid:DEFAULT_XID;
            List<HCPHost> hosts=this.hostsSet ? this.hosts:DEFAULT_HOST_LIST;
            if (hosts==null)
                throw new NullPointerException("HCPHostUpdateVer10: property hosts must not be null");
        ...
        @Override
        public HCPHostUpdate.Builder setXid(long xid) {
            this.xidSet=true;
            this.xid=xid;
            return this;
        }
        ...
        @Override
        public HCPHostUpdate.Builder setHosts(List<HCPHost> hostList) {
            this.hostsSet=true;
            this.hosts=hostList;
            return this;
        }
        ...
        @Override
        public HCPHostUpdate.Builder setDomainId(DomainId domainId) {
    ...
    public String toString() {
        StringBuilder b=new StringBuilder("HCPHostUpdate:");
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        HCPHostUpdateVer10 other = (HCPHostUpdateVer10) obj;
