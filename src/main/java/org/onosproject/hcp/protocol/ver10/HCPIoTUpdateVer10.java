...
/**
 * @Author ldy
 * @Date: 2021/1/6 上午11:07
 * @Version 1.0
 */
public class HCPIoTUpdateVer10 implements HCPIoTUpdate {
    public final static Logger logger = LoggerFactory.getLogger(HCPIoTUpdateVer10.class);
    ...
    HCPIoTUpdateVer10(long xid, DomainId domainId, List<HCPIOT> iots){
        if (iots == null){
            throw new NullPointerException("HCPIoTUpdateVer10: property iots must not be null");
        }
        if (domainId == null){
            throw new NullPointerException("HCPIoTUpdateVer10: property domainId must not be null");
        }
        this.xid = xid;
    ...
    static class Writer implements HCPMessageWriter<HCPIoTUpdateVer10> {

        @Override
        public void write(ChannelBuffer bb, HCPIoTUpdateVer10 message) {
            int startIndex = bb.writerIndex();
            //version
            bb.writeByte(WIRE_VERSION);
            //type
            bb.writeByte(HCPType.HCP_IOT_UPDATE.value());
            //temp length
    ...
    static class Reader implements HCPMessageReader<HCPIoTUpdate> {

        @Override
        public HCPIoTUpdate readFrom(ChannelBuffer bb) throws HCPParseError {
            ...
            if (type != (byte) HCPType.HCP_IOT_UPDATE.value())
                throw new HCPParseError("Wrong type:Expected=HCPType.HCP_IOT_UPDATE(13),got="+type);
            ...
            return new HCPIoTUpdateVer10(xid,domainId,iots);
        }
    }

    static class Builder implements HCPIoTUpdate.Builder{
        ...
        @Override
        public HCPIoTUpdate.Builder setXid(long xid) {
            this.xidSet = true;
            this.xid = xid;
            return this;
        }
        ...
        @Override
        public HCPIoTUpdate.Builder setIoTs(List<HCPIOT> IotList) {
            this.iotSet = true;
            this.iots = IotList;
            return this;
        }
        ...
        @Override
        public HCPIoTUpdate.Builder setDomainId(DomainId domainId) {
    ...
    public String toString() {
        StringBuilder  b = new StringBuilder("HCPIoTUpdate:");
    ...
    public boolean equals(Object o) {
        ...
        HCPIoTUpdateVer10 that = (HCPIoTUpdateVer10) o;
